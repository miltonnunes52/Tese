...
%COVER PAGE%
\includepdf[pages=1,scale=1,offset=2.5cm -2.5cm]{Capa-MIMEI.pdf}
\includepdf[pages=2,scale=1,offset=2.5cm -2.5cm]{Capa-MIMEI.pdf}
%% ----------------------------------------------------------------
...
\input{./Chapters/introduction} % Introdução

\input{./Chapters/ambient} 
...
\input{./Chapters/architectureDev}
